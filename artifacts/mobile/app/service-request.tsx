    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View>
          ...
          <View style={styles.priorityRow}>
            {PRIORITY_OPTIONS.map((opt) => (
              ...
              >
                <Text style={[styles.priorityLabel, { color: priority === opt.value ? "#fff" : colors.text, fontFamily: "Inter_600SemiBold" }]}>
                  {opt.label}
                </Text>
                <Text style={[styles.priorityDesc, { color: priority === opt.value ? "rgba(255,255,255,0.8)" : colors.textMuted, fontFamily: "Inter_400Regular" }]}>
                  {opt.desc}
                </Text>
              </TouchableOpacity>
            ))}
        ...
        <View>
          ...
          <TouchableOpacity
            style={[styles.selectBtn, { backgroundColor: colors.backgroundSecondary, borderColor: machineType ? "#10B981" : colors.border }]}
            onPress={() => setShowMachineTypes(!showMachineTypes)}
          >
            <Text style={[styles.selectBtnText, { color: machineType ? colors.text : colors.textMuted, fontFamily: "Inter_400Regular" }]}>
            ...
            <View style={[styles.dropdown, { backgroundColor: colors.card, borderColor: colors.border }]}>
              {MACHINE_TYPES.map((type) => (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    setMachineType(type);
                    setShowMachineTypes(false);
                    Haptics.selectionAsync();
                  }}
                >
                  <Text style={[styles.dropdownItemText, { color: colors.text, fontFamily: "Inter_400Regular" }]}>
                    {type}
                  </Text>
        ...
        <View>
          ...
          <TouchableOpacity
            style={[styles.selectBtn, { backgroundColor: colors.backgroundSecondary, borderColor: issueType ? "#10B981" : colors.border }]}
            onPress={() => setShowIssueTypes(!showIssueTypes)}
          >
            <Text style={[styles.selectBtnText, { color: issueType ? colors.text : colors.textMuted, fontFamily: "Inter_400Regular" }]}>
